   ...
   const publishers = usePublishers();
    ...
    return (
        <div>
            ...
            <form action="" className='flex justify-center items-center gap-6'>
    ...
    <div className="form-control">
    <input type="text" placeholder="Search here" className="input input-bordered input-error w-full text-black" />
    </div> 
