    ...
    return (
        <div>
            ...
            <div className="card outline outline-2 outline-indigo-500 py-5 px-12">
                ...
                <div>
                <h1 className='text-3xl font-semibold'>Lite</h1><br />
                </div>
                ...
                <button className='btn mt-44 w-full outline-0 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white font-semibold text-xl'>Register</button>
            </div>
            ...
            <div className="card outline outline-2 outline-orange-600  py-5 px-9">
                ...
                <button className='btn outline-0 bg-gradient-to-r from-pink-500 to-yellow-500 text-white font-semibold text-xl'>Get Premium</button>
            </div>
            </div>
        </div>
    );
